...
export class BugService {
  ...
  resolver(id: number): Observable<BugResponse> {
    return this.http.patch<BugResponse>(
  ...
  atualizar(id: number, request: AtualizarBugRequest): Observable<BugResponse> {
    return this.http.put<BugResponse>(
      `${this.baseUrl}/${id}`,
      request,
      { withCredentials: true }
    );
